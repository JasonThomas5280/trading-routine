...
| B4 | ARM | **60/100 UNCHANGED** | — | XLK / Semis | ❌ Below threshold; path unclear | C-letter GAAP improvement + base confirm | **C:10 A:10 N:15 S:5 L:15 I:5(capped) Base:0.** Price: est. ~$375-385 (KOSPI spillover -4% Jun 23; chip selloff). GAAP C-letter fails at 10/20. 67× fwd P/S. Not actionable. ⚠️ Earnings CONFIRMED Jul 29, 2026 — blackout begins ~Jul 22. `websearch_fallback` |
