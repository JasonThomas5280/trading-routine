...
**NVDA canslim-screener result:** 74/100 ❌ (1 pt below threshold; no base; Correction gate; all sources blocked) | Jul 14 price est. ~$203-210 (under pressure Jul 14 from Iran/SK Hynix; SMH +1.8% pre-mkt Jul 15 = some relief)
...
|---|---|---|---|---|---|---|---|
| B1 | NVDA | **74/100 ↑** | ↑2 (China H200 CONFIRMED + 52w high $212.19 proximity) | XLK / Semis | 🟡 Cup wk ~25; no handle; 99.2% of 52w high | Handle completion (~Aug-Sep 2026) + Alpaca+AV restore + base bonus +10 | **C:20 A:15 N:12 S:10 L:12 I:5 Base:0.** Price: $209.14 (Jul 10 close) / **$211.80 (Jul 15 CONFIRMED — AH −$0.16 → ~$211.64)**. 52w high: $212.19 = **only $0.39 away** ⬆️⬆️. ⚠️ TESTING 52-WK HIGH — if breaks $212.19 today on volume → NEW 52-WK HIGH (N-letter improves → 15 when handle also forms). MS "Overweight" reiterated Jul 15. US official formally confirmed H200 shipping to China (Alibaba/ByteDance/DeepSeek). $80B buyback confirmed. Q1 FY2027: EPS +131% YoY; revenue +85% YoY; Data Center $75B +92% YoY; 3 consecutive quarters of acceleration = C-letter remains 20/20. Vera CPU launch = new $200B market. China H200 fully confirmed Jul 10 (Alibaba/ByteDance/DeepSeek; <200K chips; reopening 20% of prior Data Center revenue). Goldman 21.7x PE "compelling" vs 72x avg. Q2 FY2027 guide: $91B (+11.7% QoQ, ~+80%+ YoY). **Needs: handle formation (~2-6 wks min) + Uptrend + base bonus = 84/100 potential.** Headwinds: (1) B200 GPU lease $6.11→$4.22/hr compression; (2) DeepSeek building own chip (Jul 9 news, NVDA slipped 2%); (3) Insider selling $410.6M ongoing; (4) Float ~24B shares (massive S-letter headwind). Aug 26 earnings — no blackout issue. `websearch_fallback` `China_H200_CONFIRMED_Jul10` `Q1FY2027_EPS_131pct_YoY` `Vera_CPU_new_market` `B200_lease_compression` `DeepSeek_own_chip_risk` |
| B2 | MRVL | **~25-40/100 ⬇️⬇️⬇️⬇️** | ↓↓ ACCELERATING DETERIORATION (Jul 13 −6.26% CONFIRMED; Jul 14 range $212.93-$231.10; Jul 15 est. $217.53 confirmed via search — further breakdown; AI capex plateau deepening) | XLK / AI Semis | ❌ BELOW THRESHOLD — broken structure; deepening damage; score revised further ⬇️ | New base formation (8+ wks minimum from ~$213 low) + FTD + Alpaca restore + CFO selling resolved | **C:10 A:10 N:5 S:3 L:3 I:4 Base:0.** Price: **Jul 10 CONFIRMED $235.81 → Jul 13 CONFIRMED ~$221 (−6.26%) → Jul 14 $217.53 CONFIRMED → Jul 15 CONFIRMED $223.43 (range $218.63-$232.87; +2.7% recovery from Jul 14)** — Note: Celestial AI + XConn Technologies acquisitions + NVDA NVLink Fusion partnership added to platform (Jul 15 news). Despite recovery, broken structure unchanged; CFO selling ongoing; AI capex deceleration narrative unchanged. Score ~25-35/100 UNCHANGED. — cumulative −7.8% from Jul 10 close. New narrative: cloud CSP capex deceleration for networking hardware; R&D cost headwinds; CFO liquidating ~50% holdings; AI spend sustainability concerns. Score revised DOWN to **~25-40/100** (from prior 30-45; L-letter and S-letter further impaired on sustained price weakness). Broken structure deepening; needs 8+ wk rebuild from ~$213 low → Nov 2026 at earliest. Not actionable this cycle or Q3. `websearch_fallback` `MRVL_Jul15_est_217.53` `MRVL_Jul14_range_212.93-231.10` `AI_capex_plateau_narrative` `CFO_liquidation_ongoing` `base_rebuild_Nov2026` |
| ❌ | ~~ARM~~ | **60/100 → EXITED UNIVERSE** | — | XLK / Semis | ❌ ⚠️ EARNINGS BLACKOUT JUL 22 = **4 TRADING DAYS** (Jul 15, 16, 17, 21) — **REMOVED FROM UNIVERSE** (/market-check Jul 15) | N/A — blackout permanently closes entry window for this cycle | **C:10 A:10 N:15 S:5 L:15 I:5 Base:0.** Price: est. ~$305-320 (Jul 15; profit-taking into earnings). ⚠️ Earnings Jul 29 → blackout Jul 22 = **3 TRADING DAYS (Jul 16, 17, 21)**. **ARM REMOVED from bench evaluation — exits actionable universe Jul 21 COB.** Re-evaluate post-earnings: Jul 29 + 5-day clearance = Aug 5+ re-entry window. `ARM_removed_Jul15_market_check` `ARM_blackout_Jul22_4days` `GAAP_C_letter_fail` `exit_watchlist_this_cycle` |
