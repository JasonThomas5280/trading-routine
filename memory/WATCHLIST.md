...
| 2 | AVGO | **est. 72/100 ❌ BELOW THRESHOLD** | XLK/Semis | Flat base Stage 2 (above pivot) | $406.75 | $378.28 (-7%) | Jun 3, 2026 ✅ | 🔴 **EXTENDED** — $433.90-$435.15 (+6.8% above $406.75 pivot; chase ceiling $427.09 breached) | May 6 intraday: $433.90-$435.15 (MOVING HIGHER — pullback to $415-427 not materializing). Extended +6.8% above pivot. Both gates fail: price extended AND score 72/100 < 75. DO NOT CHASE. Watch for consolidation: if AVGO tightens above $427 for 3-5 sessions, a new flat base could emerge with pivot ~$435. `sector_momentum_warning`. Score re-check needed when APIs restore. |
...
|---|---|---|---|
| 5 | AMD | **66/100 ❌ SCORED — BELOW THRESHOLD** | XLK/Semis. canslim-screener run 2026-05-06 /market-check. REJECT: A-letter 5/15 (GAAP FY2023 -36.9% due to Xilinx amortization); no_valid_base (post-earnings gap, 0pts). Intraday $350-354, high $359.57 (-0.9% below 52w high $362.79). Volume pace +229% above ADV (volume gate passes; price/score gates fail). Best-case non-GAAP scenario = 71/100 — still below 75. Alpaca blocked (day 29). **Re-evaluate: base formation ~3-6 weeks. Earliest re-score: week of June 9.** `sector_momentum_warning`. `no_valid_base`. DO NOT ENTER. |
