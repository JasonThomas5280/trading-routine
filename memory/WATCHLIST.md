...
**Built:** 2026-05-03 (Sun) — `/weekly-prep` | **Refreshed:** 2026-05-07 (Thu) — `/pre-market` | `research_source: websearch_fallback` (Perplexity + Alpaca both blocked — IP allowlist; Alpaca day 31)
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | MU | **est. 72→76/100 ⚠️ BORDERLINE** | XLK/Memory | Flat base / ATH breakout | ~$545–546 est. (ATH; Alpaca blocked) | entry × 0.93 | ~Jul 1, 2026 ✅ | 🔴 **EXTENDED** — $666.59 (+22.1% above ~$546 pivot); `climax_top_risk_flag` CRITICAL++ | May 7 pre-mkt: **$666.59** (high $667.67, low $627.58). Fitch credit upgrade → stock surged 11% to new record; $700B market cap milestone. New product: 245TB 6600 ION SSD (largest commercial SSD). +22.1% above pivot — NO BASE to re-enter. `climax_top_risk_flag` CRITICAL++. Watch for multi-week consolidation; new pivot may emerge at $640-660 range after base forms (~4-6 weeks). C-letter EPS +405% YoY. `sector_momentum_warning: XLK lagging RRG`. |
| 2 | AVGO | **est. 72/100 ❌ BELOW THRESHOLD** | XLK/Semis | Flat base Stage 2 (above pivot) | $406.75 | $378.28 (-7%) | Jun 3, 2026 ✅ | 🟡 **WATCHING** — $424.02 (+4.2% above pivot; WITHIN buy zone $406.75-$427.09) | May 7: $424.02 (high $438.90, low $417.78). Price is within the buy zone — favorable. Intraday low $417.78 (+2.7% from pivot) also in zone. BUT score 72/100 < 75 → conviction gate fails. 29 analysts: Strong Buy, avg PT $451. Most actionable name when APIs restore + fresh score ≥75 confirmed. NO ENTRY today (score + Alpaca + NFP gate). `sector_momentum_warning`. |
