...
| B2 | MRVL | **71-73/100 ⬆️** | ↑↑ (RS recovery + UBS upgrade + Amazon AI read-through) | XLK / AI Semis | 🟡 WATCHING — pre-mkt ~$278.78; recovering; no base | FTD + Alpaca restore + 3-5 wk base completion | **C:15 A:10 N:15 S:10 L:15→16 I:6→7 Base:0.** Price: ~$278.78 pre-market Jul 1 (vs $252.62 Jun 29 selloff low; +10.4% recovery in 2 days). YTD +247%. UBS upgrade Jun 29: $230→$340 PT (CXL market leadership + AI connectivity). Amazon Trainium read-through (Jul 1): AWS data center chip opportunity positive for MRVL custom silicon. NVIDIA-Marvell equity collaboration confirmed. L-letter recovering strongly. No new base yet; 3-5 wk consolidation from ~$252-280 range. Score approaching 73 but Correction blocks entry. `websearch_fallback` `UBS_upgrade_340_Jun29` `Amazon_Trainium_readthrough_Jul1` `NVDA_MRVL_collaboration` `S&P500_inclusion_Jun22` |
| B3 | LRCX | **72-74/100 ⬆️** | ↑3-4 (triple analyst upgrade + RS leadership) | XLK / Semi Equip | 🟡 CLOSEST TO THRESHOLD; no base | Base formation + Correction end + Alpaca restore | **C:15 A:5 N:15 S:10 L:15 I:7→8 Base:0.** Price: ~$419.92 Jun 30 (range $379-$420; up from ~$395 Jun 29 close = +6% more). Triple analyst upgrade: BofA $330→$480 (Buy) + WF $365→$450 (OW) + Cantor $425→$500 (OW). Record revenue + AI advanced packaging + HBM wafer fab demand. Score 72-74/100 — CLOSEST to 75 threshold but no base = not actionable. ⚠️ Earnings Jul 29 — blackout begins ~Jul 22 (5 trading days); entry window through ~Jul 18 ONLY. `websearch_fallback` `LRCX_triple_analyst_upgrade` `AI_capex_wafer_fab` |
