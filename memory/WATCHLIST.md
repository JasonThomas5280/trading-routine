...
| B2 | MRVL | **~40-50/100 ⬇️⬇️⬇️⬇️ FURTHER DOWNGRADE** | ↓↓↓↓ (−27% from ATH; −8.75% Jul 7; $252 support BROKEN Jul 2; V-recovery INVALIDATED; post-S&P inclusion sell-off) | XLK / AI Semis | ❌ BELOW THRESHOLD — broken structure; further damaged Jul 7 | New base formation (8+ wks minimum from ~$230 low) + FTD + Alpaca restore + CFO selling resolved | **C:15 A:10 N:7 S:5 L:5 I:3 Base:0.** Price: **~$230-234 est. (Jul 7 close; −8.75% on Samsung selloff + post-S&P inclusion profit-taking + CFO Meintjes liquidation + rate pressure).** −27% from $316.43 ATH. Structure shattered; no base; 8+ wk rebuild minimum from current levels. Ex-div $0.06 ex-date **Jul 10** [CORRECTED from erroneously noted Jul 8 — confirmed per investor.marvell.com]. `websearch_fallback` `V_recovery_invalidated_Jul2` `MRVL_8pct75_Jul7_Samsung_selloff` `CFO_liquidation_Meintjes` `ex_div_Jul10_corrected` |
