...
| ❌ | ~~ARM~~ | **60/100 → EXITED UNIVERSE** | — | XLK / Semis | ❌ ⚠️ EARNINGS BLACKOUT JUL 22 = **2 TRADING DAYS** (Jul 17, 21) — **REMOVED FROM UNIVERSE** (/market-check Jul 15; updated Jul 16) | N/A — blackout permanently closes entry window for this cycle | **C:10 A:10 N:15 S:5 L:15 I:5 Base:0.** Price: est. ~$305-320. ⚠️ Earnings Jul 29 → blackout Jul 22 = **2 TRADING DAYS (Jul 17, 21)**. **ARM REMOVED from bench evaluation — exits actionable universe Jul 21 COB.** Re-evaluate post-earnings: Jul 29 + 5-day clearance = Aug 5+ re-entry window. `ARM_removed_Jul15_market_check` `ARM_blackout_Jul22_2days_remaining` `GAAP_C_letter_fail` `exit_watchlist_this_cycle` |
