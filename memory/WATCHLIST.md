...
| B2 | MRVL | **~25-40/100 ⬇️⬇️⬇️⬇️** | ↓↓ ACCELERATING DETERIORATION (Jul 13 −6.26% CONFIRMED; Jul 14 range $212.93-$231.10; Jul 15 est. $217.53 confirmed via search — further breakdown; AI capex plateau deepening) | XLK / AI Semis | ❌ BELOW THRESHOLD — broken structure; deepening damage; score revised further ⬇️ | New base formation (8+ wks minimum from ~$213 low) + FTD + Alpaca restore + CFO selling resolved | **C:10 A:10 N:5 S:3 L:3 I:4 Base:0.** Price: **Jul 10 CONFIRMED $235.81 → Jul 13 CONFIRMED ~$221 (−6.26%) → Jul 14 range $212.93-$231.10 → Jul 15 10AM est. ~$217.53 (search confirmed, down $18.28 from Jul 10)** — cumulative −7.8% from Jul 10 close. New narrative: cloud CSP capex deceleration for networking hardware; R&D cost headwinds; CFO liquidating ~50% holdings; AI spend sustainability concerns. Score revised DOWN to **~25-40/100** (from prior 30-45; L-letter and S-letter further impaired on sustained price weakness). Broken structure deepening; needs 8+ wk rebuild from ~$213 low → Nov 2026 at earliest. Not actionable this cycle or Q3. `websearch_fallback` `MRVL_Jul15_est_217.53` `MRVL_Jul14_range_212.93-231.10` `AI_capex_plateau_narrative` `CFO_liquidation_ongoing` `base_rebuild_Nov2026` |
| ❌ | ~~ARM~~ | **60/100 → EXITED UNIVERSE** | — | XLK / Semis | ❌ ⚠️ EARNINGS BLACKOUT JUL 22 = **4 TRADING DAYS** (Jul 15, 16, 17, 21) — **REMOVED FROM UNIVERSE** (/market-check Jul 15) | N/A — blackout permanently closes entry window for this cycle | **C:10 A:10 N:15 S:5 L:15 I:5 Base:0.** Price: est. ~$305-320 (Jul 15; profit-taking into earnings). ⚠️ Earnings Jul 29 → blackout Jul 22 = 4 trading days. **ARM REMOVED from bench evaluation effective today (Jul 15).** Re-evaluate post-earnings: Jul 29 + 5-day clearance = Aug 5+ re-entry window. `ARM_removed_Jul15_market_check` `ARM_blackout_Jul22_4days` `GAAP_C_letter_fail` `exit_watchlist_this_cycle` |
