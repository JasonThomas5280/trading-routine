...
| B2 | MRVL | **~30-45/100 ⬇️⬇️⬇️** | ↓ FURTHER DETERIORATION (Jul 13 −6.26% / Jul 14 range $212.93-$231.10 CONFIRMED via search; AI capex plateau narrative emerging) | XLK / AI Semis | ❌ BELOW THRESHOLD — broken structure; deepening damage | New base formation (8+ wks minimum from $213 low) + FTD + Alpaca restore + CFO selling resolved | **C:15 A:10 N:5 S:3 L:3 I:4 Base:0.** Price: **Jul 10 CONFIRMED $235.81 → Jul 13 est. ~$221 (−6.26%) → Jul 14 range $212.93-$231.10 CONFIRMED** (further −5-7% from Jul 10). New narrative: cloud CSP capex deceleration for networking hardware; R&D cost headwinds; CFO liquidating ~50% holdings. Score revised DOWN to **~30-45/100** from prior 40-50. Broken structure deepening; analyst Hold rating; needs 8+ wk rebuild from ~$213 low → Nov 2026 at earliest. Not actionable this cycle. `websearch_fallback` `MRVL_Jul14_range_212.93-231.10` `AI_capex_plateau_narrative` `CFO_liquidation_ongoing` `base_rebuild_Nov2026` |
| ❌ | ~~ARM~~ | **60/100 → EXIT WATCH** | — | XLK / Semis | ❌ ⚠️ EARNINGS BLACKOUT JUL 22 = **4 TRADING DAYS** (Jul 15, 16, 17, 21) — EXITING UNIVERSE | N/A — blackout permanently closes entry window for this cycle | **C:10 A:10 N:15 S:5 L:15 I:5 Base:0.** Price: est. ~$305-320 (Jul 15 pre-mkt; profit-taking into earnings). **⚠️ Earnings Jul 29 → blackout begins Jul 22 = 4 trading days from today.** ARM exits the actionable universe this cycle permanently after Jul 21 COB. Remove from bench evaluation next week. Re-evaluate after Jul 29 earnings + 5-day clearance (~Aug 5+). `ARM_blackout_Jul22_4days` `GAAP_C_letter_fail` `exit_watchlist_this_cycle` `profit_taking_preearnings` |
