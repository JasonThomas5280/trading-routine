...
|---|---|---|---|---|---|---|---|---|
| 1 | AVGO | ~80 | Tech/Semis | **BREAKOUT — closed ATH $422.65 on Apr 22; now retesting pivot** | $406.75 (original) | $390.60 (-7% from $420) | ~2026-06-05 | 🟡 WATCHING. Pre-market 2026-04-24: ~$405.33 (+0.79% overnight), near original $406.75 pivot. No negative catalyst — Google Cloud + Meta AI chip partnerships intact. Pulled back from $422.65 ATH, likely spillover from Apr 23 software sector selloff. Volume unverifiable (Alpaca blocked). If opens at/above pivot on any volume pickup = potential second-chance entry. Chase ceiling $427.09. **No entry today — Alpaca API unavailable.** Re-score Sunday /weekly-prep. |
| 2 | NVDA | ~67 | Tech/Semis | At 52wk high, no valid base | $201.75 | $187.63 (-7%) | ~2026-05-28 | 🔴 BELOW THRESHOLD. Pre-market 2026-04-24: ~$199.50, below $201.75 pivot. Conviction 67/100 < 75. No new catalyst (Oklo nuclear deal = infrastructure, not price-moving). Do NOT enter until conviction re-scores ≥75 AND volume confirms. |
| 3 | STX | ~75 | Tech/Storage | Extended; multiple analyst upgrades | $554.00 | $515.22 (-7%) | ~2026-04-28 ⚠️ | ⛔ EARNINGS BLACKOUT — TODAY is last trading day before April 28 earnings. **DO NOT ENTER.** BULLISH overnight: Barclays upgraded OW PT $625; UBS PT $515; Mizuho OW PT $565. AI cloud storage demand "sold out" narrative strong. Re-evaluate post-earnings at Sunday /weekly-prep. |
