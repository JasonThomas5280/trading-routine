...
|---|---|---|---|---|---|---|---|---|
| 1 | AVGO | ~80 | Tech/Semis | **ATH breakout Apr 22 ($422.65); pivot retesting/holding** | $406.75 (original) | $390.60 (-7% from $420) | ~2026-06-05 | 🟡 WATCHING. **2026-04-24 /market-check:** Intraday range $408.86–$428.90. Pivot $406.75 held as support (low $408.86 = bullish). Briefly extended to $428.90 (above $427.09 chase ceiling), pulled back to $415.36. Volume: 6.7M at 90min → +30% paced vs +40% required — NOT triggered. Alpaca blocked (day 6) = no execution possible. Setup intact — pivot holding, volume approaching threshold. **Re-score Sunday /weekly-prep for potential entry Mon/Tue.** |
