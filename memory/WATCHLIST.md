...
|---|---|---|---|---|---|---|---|
| B1 | NVDA | **73/100** ⬆️ | ↑5 from 68 | XLK / Semis | 🟡 Cup wk 12-13; no handle | Handle completion (~Aug 2026) + Alpaca+AV restore | **C:20 A:15 N:8 S:10 L:15 I:5(capped) Base:0.** L upgraded: XLK top-3 sector → +5 (was +3 when XLK ranked #4-6). S upgraded: active buyback + volume surge = 10 (was 5). I capped at 5 (EDGAR stale). N: ATH $235.47 May 14; current $210.69 = −10.5% off ATH; within 15% = 3pts + Blackwell/Apple AI catalyst = +5 = 8pts. Cup forming wk 12-13; needs handle 3-4 wks before pivot. Timeline: base complete ~Aug 2026. Shareholders mtg Jun 24 (governance; not earnings — clear). `websearch_fallback` `cached_fundamentals` |
| B2 | MRVL | **70/100** 🆕 | NEW | XLK / AI Semis | 🟡 Watch — potential flat base forming | FTD fires + Alpaca bars confirm base → est. 80/100 | **C:15 A:10 N:15 S:10 L:15 I:5(capped) Base:0.** C: Q1 FY2027 rev $2.418B record +28% YoY; non-GAAP EPS $0.80 (est. ~40%+ YoY growth given rev leverage = 15pts). A: FY2027 guidance $11B (30%+ annual growth); likely 2 confirmed years ≥25% + ROE estimate = 10pts. N: at/near new 52w high wk Jun 12 = 10pts + AI custom silicon (hyperscaler ASIC leader) = +5pts. S: float ~860M = 0pts; breakout vol +6% wk = 5pts; est. buyback = 5pts. L: YTD +230%, RS ≥90 = 10pts; XLK top-3 = +5pts. Next earnings ~Aug 2026 (clear). PRIORITY RESCAN on FTD. `websearch_fallback` |
