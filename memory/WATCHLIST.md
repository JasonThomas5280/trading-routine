...
| B2 | MRVL | **71/100** ⬆️ recovering | ↑ (RS bounce) | XLK / AI Semis | 🟡 WATCHING — pre-mkt bounce $272-278; no base | FTD + Alpaca restore + 3-5 wk base completion | **C:15 A:10 N:15 S:10 L:15 I:6 Base:0.** Price: $272-278 pre-market Jun 30 (vs $252.62 Jun 29 close = +8-10% bounce; recovering from severe -4.97% underperformance Jun 29). YTD +247%. S&P 500 inclusion Jun 22 (forced institutional buy absorbed). Q1 FY2027 (May 27): Rev $2.42B (+27.6% YoY), Q2 guide $2.7B. Full-year rev growth +40% toward $11.5B. L-letter improving as RS recovers. No new base yet; 3-5 wk consolidation needed. `websearch_fallback` `S&P500_inclusion_Jun22` `Q1FY27_strong_earnings_May27` `CFO_transition_orderly` |
