...
**Effective count: 4/25** (Apr 23, Apr 28, May 4, May 7 SPY dist days; Apr 29 + Apr 30 + May 1 + May 5 + May 6 + May 8 were UP days; vol ratios unconfirmed — Alpaca blocked; magnitude threshold met with high confidence on all 4 active days)
...
**⚠️ data_confidence: websearch_fallback** — Alpaca API blocked (403 Host not in allowlist) Day 33. Vol ratios for all 4 dist days unconfirmed; magnitude threshold met with high confidence. MA values confirmed via Barchart (reliable source).
...
**Current rally status:** Confirmed (FTD fired 2026-04-08, uptrend in day 32 as of 2026-05-10 Sunday). S&P 500 actual close May 8: 7,398.93 (corrected from websearch_fallback estimate of 7,337.11). SPY $737.62. SPY above 50d MA +3.71% ($711.26). Uptrend intact but elevated distribution day count (4/25 — ONE away from Under Pressure). CPI Tuesday May 12 is primary dist day #5 risk. Alpaca API blocked 33 consecutive days — no execution possible. NVDA earnings blackout starts May 13. Powell's term ends May 15 (Warsh transition).
