...
**Status:** 🔴 **MARKET IN CORRECTION — UNCHANGED** *(Jun 19 /pre-market: ⚠️ Juneteenth — US MARKETS CLOSED — 🕊️ IRAN DEAL SIGNED at Burgenstock, Switzerland (14-pt MoU; Strait of Hormuz reopened; hostilities ended; nuclear talks postponed = separate track) — Futures surging heading into weekend — Oil falling (DEFLATIONARY/BULLISH) — Intel-Apple: still unconfirmed by either company — FTD Day 7 = Jun 22 Mon (LAST; threshold ~7,598; probability UPGRADED to MODERATE 35-45% on Iran deal catalyst) — 7/25 dist days UNCHANGED — May 15 dist expires Jun 22 → 6/25 (STILL CORRECTION without FTD) — Alpaca Day 102 BLOCKED — 0 positions — 0 candidates ≥75)*

**Last updated:** 2026-06-19 (Fri/Juneteenth) — `/pre-market` 6:00 AM CT — **⚠️ JUNETEENTH — MARKETS CLOSED — 🕊️ IRAN DEAL SIGNED BURGENSTOCK — FUTURES SURGING — OIL FALLING — FTD DAY 7 MON JUN 22 LAST WINDOW (THRESHOLD ~7,598; MODERATE PROB) — ALPACA DAY 102 BLOCKED**
