...
**Status:** 🔴 **MARKET IN CORRECTION — UNCHANGED** *(Jun 30 /pre-market: S&P 7,417.45 prior close — 6/25 dist days UNCHANGED — FTD window CLOSED (next requires new Day 1 = S&P close BELOW 7,266.99) — Rally low 7,266.99 INTACT (150 pts) — Futures ES ~+0.2% NQ ~flat (tech rebounding early; investors reassessing AI trade) — ISM Mfg PMI Jun: 55.7 BEAT (expansionary) — MRVL pre-mkt $272-278 +8-10% bounce — LRCX ~$420 triple upgrade — ARM downgraded New Street Neutral — Q2/EOM dist day #7 risk — Alpaca Day 114 BLOCKED — 0 positions — Warsh Jul 1 hawkish risk — NFP Jul 2 (172K consensus))*

**Last updated:** 2026-06-30 (Tue) — `/pre-market` 6:00 AM CT — **🔴 CORRECTION UNCHANGED — 6/25 DIST DAYS — ES +0.2% NQ FLAT — ISM MFG PMI 55.7 BEAT — MRVL $272-278 PRE-MKT BOUNCE — LRCX ~$420 TRIPLE UPGRADE — ARM DOWNGRADED — ALPACA DAY 114 BLOCKED — 0 POSITIONS — WARSH JUL 1 — NFP JUL 2**
**STATE:** 🔴 Market in Correction | UNCHANGED | **6/25 dist days** (Jun 3, Jun 5, Jun 9, Jun 10, Jun 17, Jun 23) | No expiries until Aug 8 (Jun 3 oldest) | FTD window CLOSED (Day 7 failed Jun 22; next FTD requires new Day 1 = S&P close BELOW 7,266.99) | Rally attempt INTACT (S&P 7,417.45 vs low 7,266.99 = 150 pts margin)
