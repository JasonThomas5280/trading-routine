...
**Status:** 🔴 **MARKET IN CORRECTION — UNCHANGED** *(Jun 25 /pre-market 6:00 AM CT: S&P futures +0.79% (~7,416 implied open) on MU +15-16% AH massive earnings beat; NQ futures climbing strongly; PCE data TODAY 8:30 AM ET / 7:30 AM CT — HOT forecast (4.1% YoY headline) → dist day risk if PCE prints hot and market reverses; FTD window CLOSED; Rally low 7,266.99 INTACT (margin widens to ~149 pts if futures hold); Alpaca Day 110 BLOCKED; 0 positions; NO ENTRIES)*

**Last updated:** 2026-06-25 (Thu) — `/pre-market` 6:00 AM CT — **🔴 CORRECTION UNCHANGED — S&P FUTURES +0.79% — MU +15-16% AH CONFIRMED BEAT — PCE TODAY 7:30 AM CT (HOT FORECAST 4.1%) — DIST DAY RISK — ALPACA DAY 110 BLOCKED — 0 POSITIONS**
**STATE:** 🔴 Market in Correction | UNCHANGED | **6/25 dist days** (Jun 3, Jun 5, Jun 9, Jun 10, Jun 17, Jun 23; May 15 expired Jun 22; May 19 expired Jun 23) | FTD window CLOSED (Day 7 failed Jun 22; next FTD requires new Day 1 below 7,266.99) | Rally attempt INTACT (7,358.22 >> 7,266.99 low; ~91 pts margin at Jun 24 close; widens ~149 pts if futures open holds)
