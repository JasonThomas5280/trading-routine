...
**Status:** 🔴 **MARKET IN CORRECTION** *(Dist Day #6 Jun 5 confirmed; 5/25 after May 4 expiry Jun 8; state stays CORRECTION until FTD)*

**Last updated:** 2026-06-07 (Sun) — `/weekly-prep` 4:00 PM CT | `research_source: websearch_fallback` | Alpaca Day 83+ BLOCKED | **⚠️ JUN 5 DATA RECORRECTION: S&P actual close 7,383.74 (−2.64%) NOT 7,446.24 (−1.82%) as prior entries estimated. 50d MA CORRECTED: ~$712 NOT ~$740. SPY at $738 is +3.7% ABOVE 50d MA (not AT it). State remains 🔴 CORRECTION (6 dist days; 5/25 after Jun 8 expiry).**
**STATE:** 🔴 Market in Correction | Dist day #6 confirmed Jun 5 (S&P **7,383.74 −2.64% / −200.57 pts** on elevated volume; NFP 172K beat → 10Y yield surge → chips worst day since Apr 2025; AVGO −7.92%, NVDA −6.2%, Nasdaq −4.2%) | State: Uptrend Under Pressure → Correction
**Distribution days: 5/25** (May 7, May 15, May 19, Jun 3, Jun 5 — May 4 expired Jun 8 close) | State REMAINS Correction until FTD | May 7 expires ~Jun 11 → 4/25 but no state change
**⚠️ JUN 5 DATA RECORRECTION (Jun 7 /weekly-prep WebSearch cross-check):** Prior entries estimated S&P Jun 5 at 7,446.24 (−1.82%) and SPY "at 50d MA ~$740." Both wrong. Actual: S&P **7,383.74 (−2.64% / −200.57 pts)**, SPY **~$738.37**. 50d MA is **~$712** (not $740) — SPY is 3.7% ABOVE its 50d MA. 200d MA: **~$681**. AVGO confirmed close Jun 5: **$385.73** (−7.92% from Jun 4 close $418.91; moved below 50d MA ~$397-$422). NVDA confirmed close Jun 5: **$205.10** (−6.2%). Nasdaq Jun 5: **25,709.43** (−4.2%). The Jun 5 selloff was the worst day since October 2025. Source: Yahoo Finance, CNBC, TheStreet.
**SPY Jun 5 confirmed: $738.37** | 50d MA: **~$712** (+3.7%) | 200d MA: **~$681** (+8.4%) | QQQ Jun 5: **~$720-724 est.** (−4.2%) | S&P 7,383.74 | Nasdaq 25,709.43
**SH/SQQQ hedge:** TRIGGERED by Correction state → SH $625 (25% sizing) queued | BLOCKED: Alpaca Day 83+ | Execute immediately on Alpaca restore
**AVGO:** Jun 5 actual close **$385.73** (−7.92% from $418.91; cumulative −19.1% from Jun 3 session close $477.01). Broke BELOW 50d MA (~$397–$422) on heavy vol = 50d MA break sell signal triggered. Score est. **45–55/100**. NOT re-scoreable until new base forms from ~$385 support (est. 6–10 week timeline). Fundamental story intact (C/A letters) but L, N, S all damaged severely. Remove from bench until base forms.
**NVDA:** Jun 5 actual close **$205.10** (−6.2%; 13.3% below ATH $236.54). Support at $199.57. Score revised to **65/100 (no base) → 75/100 with valid base** (barely passes). L-letter weakened (XLK not top-3 sector 4-wk RS post-selloff). Base formation needed: est. 5-8 weeks from Jun 5 bottom → est. Jul 10-Jul 31. 🟡 BENCH.
**DELL:** Jun 5 est. **~$415–430** (broadly down with tech; prior ATH ~$465 Jun 3; consolidating post-gap). Score 74/100 no base → est. 82–84/100 with base and A-letter GAAP confirmed. Base formation: est. 4–6 weeks from Jun 5. 🟡 BENCH.
**0 candidates pass conviction ≥75** | 0 primary watchlist items | 0 open positions
**Open positions: 0 | Equity: $2,500 (HWM) | Weekly trades: 0/3 RESET | Alpaca: Blocked Day 83+ | `research_source: websearch_fallback`**
**Week of Jun 9-13 priorities:** (1) 🚨 Alpaca restore CRITICAL (2) Execute SH $625 hedge FIRST ORDER on restore (3) CORRECTION — no new longs until FTD (4) CPI Wed Jun 10: BINARY EVENT — hot = more dist risk (→ Day #7+); soft = FTD fuel (5) FTD path: if Jun 8 closes UP = Day 1 → FTD eligible Jun 12 (Fri) at earliest (6) NVDA base progress check (7) AVGO removed from bench — 50d MA break on vol; re-evaluate after 6-week base forms (8) Rally attempt from May 19 (SPY $733.39 low) remains intact — Jun 5 close $738 > Day 1 low ✅

**✅ JUN 7 SUN /weekly-prep (4:00 PM CT — ⚠️ JUN 5 DATA RECORRECTION — 🔴 CORRECTION STATE — WEEK OF JUN 9-13 SETUP):**
- **⚠️ JUN 5 FINAL DATA CORRECTION:** S&P Jun 5 actual close **7,383.74 (−2.64% / −200.57 pts from 7,584.31)**. Nasdaq 25,709.43 (−4.2%). Dow 50,866.78 (−1.3%). Source: Yahoo Finance ("How major US stock indexes fared Friday 6/5/2026"), CNBC live blog. This supersedes ALL prior estimates (7,446.24, ~7,536, etc.). Jun 5 was the WORST single day since October 2025.
- **⚠️ 50d MA CORRECTION:** SPY 50-day SMA is **~$712** (from technical analysis sources), NOT $740 as previously estimated in websearch_fallback mode. SPY Jun 5 close ~$738.37 is **+3.7% ABOVE** its 50d MA — the "at 50d MA" statement in prior entries was wrong. 200d MA: **~$681**. SPY +8.4% above 200d MA. Prior state entries that cited "SPY at 50d MA = additional sell signal" are corrected here.
- **⚠️ AVGO DATA CORRECTION:** Jun 5 close confirmed **$385.73** (−7.92% from Jun 4 close $418.91, NOT −10.5% from pre-market $413.45 as estimated). AVGO 50d MA: ~$397–$422. AVGO is now BELOW its 50d MA — genuine sell signal.
- **⚠️ NVDA DATA CORRECTION:** Jun 5 close **$205.10** (−6.2%; 52-wk range $140.85–$236.54). Prior estimates of ~$209 were close but now confirmed at $205.10. Support: $199.57.
- **Market state: 🔴 CORRECTION** | Distribution: 5/25 (May 4 expires Jun 8) → 4/25 approx Jun 11 (May 7 expiry). State REMAINS Correction until FTD regardless of count.
- **Rally attempt:** May 19 Day 1 SPY $733.39 low is INTACT (Jun 5 close $738.37 > $733.39). Jun 5 was DOWN → NOT new Day 1. If Jun 8 closes UP: Day 1 of rally attempt → FTD eligible Day 4-7 (Jun 12 Fri at earliest).
- **Sector rotation (4-wk May 8–Jun 5):** #1 XLE Energy (+oil premium, Iran/Hormuz, +26-27% YTD), #2 XLI Industrials (DELL +757% AI servers, AI infra), #3 XLF Financials (NFP beat → higher-for-longer → bank NIM). Bottom: XLU (rate spike), XLRE (rate spike), XLK (chips worst sector Jun 5). | XLK NOT top-3 → no sector bonus for XLK names.
- **Bench status:** NVDA 65/100 (no base) → 75/100 with base (barely passes) | DELL 74/100 (no base) → est. 82–84/100 with base | AVGO REMOVED from bench (50d MA break on vol Jun 5)
- **Week of Jun 9-13 FTD pathway:** Jun 8 Up → Day 1 → FTD window Jun 12-15 | **Wed Jun 10 CPI**: hot (+4.2% est.) = dist day risk → Correction deepens; soft (<4.0%) = FTD fuel. **Jun 16-17 FOMC** (following week — no entries Jun 15 AM per strategy). U of Mich Sentiment Jun 12 (Fri). No major earnings on watchlist names.
- **Alpaca: Day 83+ BLOCKED** | Perplexity: 403 | AV: 403 | All APIs blocked (network policy) | `research_source: websearch_fallback`
- **Circuit breakers:** ALL CLEAR | P&L: $0 | Equity: $2,500 (HWM) | Weekly trades: 0/3 RESET
- **Actions: NONE** (Correction + Alpaca blocked) | SH/SQQQ hedge: QUEUED — FIRST ORDER on Alpaca restore
