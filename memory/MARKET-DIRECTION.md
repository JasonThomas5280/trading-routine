...
**Status:** 🔴 **MARKET IN CORRECTION — UNCHANGED** *(Jun 18 /eod-review 3:15 PM CT: S&P +1.15% ~7,505 — FTD Day 6 FAILED (+1.15% < +1.25%; 7.5 pts short of 7,513) — NOT dist day | 7/25 dist days UNCHANGED | Intel +8.9% Apple chip deal (unconfirmed by companies); SOX +6% record | Day 7 = Jun 22 Mon (LAST FTD WINDOW; Jun 19 Juneteenth CLOSED; Jun 20–21 weekend) ⚠️ CALENDAR CORRECTION: prior logs said "Day 7 = Jun 20 Fri" — Jun 20 is Saturday; correct Day 7 = Jun 22 Mon | FTD threshold Jun 22: ~7,598 | Alpaca Day 101 BLOCKED | 0 positions | 0 candidates ≥75)*

**Last updated:** 2026-06-18 (Thu) — `/eod-review` 3:15 PM CT — **🔴 CORRECTION UNCHANGED — FTD DAY 6 FAILED S&P +1.15% ~7,505 (7.5 PTS SHORT OF 7,513) — NOT DIST DAY — INTEL +8.9% APPLE CHIP DEAL (UNCONFIRMED) SOX +6% RECORD — NASDAQ +1.5% RUSSELL −0.72% — DAY 7 = JUN 22 MON (LAST FTD WINDOW) — ALPACA DAY 101 BLOCKED**
...
**Technical picture (Jun 18 close):** S&P ~7,505 (+1.15%) | 50d MA ~7,248 | **+3.55% above 50d** | 200d MA ~6,882 | **+8.90% above 200d** | QQQ ~$731 est. (+1.5%) | Both above 50d = structural uptrend intact; Correction active
**Rally attempt:** ⚠️ **Day 6 FAILED — NOT FTD** | Rally low: **7,266.99 (Jun 10)** | Jun 18 close ~7,505 → 238 pts ABOVE rally low ✅ (rally attempt INTACT) | **FTD window: Day 7 = Jun 22 (Mon — LAST; Jun 19 Juneteenth CLOSED; Jun 20–21 weekend)** | ⚠️ CALENDAR CORRECTION: prior logs said "Day 7 = Jun 20 (Fri, triple witching)" — Jun 20 is Saturday; correct Day 7 = Jun 22 (Mon) | FTD threshold Jun 22: ~7,598 (7,505 × 1.0125) | **FTD probability: LOW** (need +1.24% on hawkish Fed backdrop)
