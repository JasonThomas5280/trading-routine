...
**Status:** 🔴 **MARKET IN CORRECTION** *(Jun 14 /weekly-prep: S&P 7,431.46 (Jun 12 close) | 50d MA ~7,248 (+2.53%) | 200d MA ~6,882 (+7.97%) | Dist 6/25 UNCHANGED | DAY 3 = Mon Jun 15 | FTD window Day 4–7: Jun 16–19 | 🔴 IRAN DEAL TRUMP "SIGNING TODAY" (Jun 14) 🔥 = MASSIVE FOMC-WEEK FTD CATALYST | Alpaca Day 92 BLOCKED | Perplexity 403 | AV 403 | DELL RE-SCORED 55/100 — DOWNGRADED from 74 | NVDA 68/100 revised | 0 candidates ≥75)*

**Last updated:** 2026-06-14 (Sun) — `/weekly-prep` 4:00 PM CT — **🔴 CORRECTION UNCHANGED | RALLY DAY 3 = JUN 15 (MON) | FTD WINDOW DAY 4 (JUN 16 FOMC ⚠️) – DAY 7 (JUN 19) | 🔥 IRAN DEAL TRUMP "TO BE SIGNED TODAY" JUN 14 = MAJOR BULLISH CATALYST | DELL DOWNGRADED 74→55/100 | NVDA 72→68/100 RUBRIC-STRICT | 0 CANDIDATES ≥75 | ALPACA DAY 92 BLOCKED**
**STATE:** 🔴 Market in Correction | UNCHANGED | **6/25 dist days** (May 15, May 19, Jun 3, Jun 5, Jun 9, Jun 10) | Needs FTD to upgrade | May 15 expires Jun 19 → 5/25 (STILL CORRECTION until FTD)
...
**FOMC Jun 16-17 (CRITICAL):** First Kevin Warsh FOMC | 65% hold (3.50-3.75% current), 33% cut | No entries before 1 PM CT Jun 16 | If cut → massive rally = likely FTD | If hold + neutral language → FTD possible Jun 17-19 | Hot CPI (May +4.2%) = rate hike bias shift risk
**NVDA:** $205.19 (Jun 12 close) | ATH $235.47 (May 14) | -12.86% off ATH | Cup forming (5 wks, no handle, no pivot) | **Score: 68/100 ↓ (was 72)** | Rubric change: -12.86% off ATH = "within 15%" (N:3 not 10); XLK sector rank 4-6 in 4-wk (L:-2) | With base: 78/100 | 🟡 BENCH | Timeline Aug 2026+
**DELL:** $395.57 (Jun 12 confirmed) | ATH $465.96 (Jun 1) | -15.1% off ATH | Silver Lake selling $55M Jun 8, $9.4M Jun 10 (supply overhang) | **Score: 55/100 ↓↓ (was 74) — DOWNGRADED to WATCH-ONLY** | No base. Even with base: 65/100 = still below 75. Key drivers: >15% off ATH (N:0 proximity), Silver Lake overhang (I:-2, S: weakened), XLK 4-wk rank 4-6 (L:+3 not +5) | ❌ NOT ACTIONABLE — re-score only when: (1) Silver Lake selling halts AND (2) base forms (3-4 wks minimum from $370-400 zone)
**AVGO:** est. ~$384-388 (Jun 12) | CFO transition Spears→Thuener | **55/100 UNCHANGED** | Watch-only | Next re-score trigger: new base complete (~6-8 wks from current levels)
**JPM (XLF — new eval):** $320.72 (Jun 12) | Q1 2026 EPS +17.16% YoY → **REJECTED: C-letter < 25% threshold (DISQUALIFYING)** | GS $1,093-1,098 → **REJECTED: price >$500 ceiling**
**0 candidates ≥75** | 0 primary watchlist items | 0 open positions
**Open positions: 0 | Equity: $2,500 (HWM) | Weekly trades: 0/3 | Alpaca: Blocked Day 92 | `research_source: websearch_fallback`**
**Week of Jun 15 priority items:** (1) 🚨 Alpaca restore CRITICAL — SH $625 FIRST order on restore (Correction still active) (2) 🔥 Iran deal signed → Mon Jun 15 gap-up → watch Day 3 holds 7,266.99 (3) FOMC Jun 16-17 no entries before 1 PM CT (4) FTD window Day 4-7 Jun 16-19 (5) May 15 dist expires Jun 19 → 5/25 (still Correction) (6) NVDA base watch — 5 wks old; needs 3+ more wks + handle before pivot
**Sector RS leaders (4-week, May 14→Jun 12):** 1. XLF Financials (GS at 52-wk highs; dealmaking) 2. XLI Industrials (AI capex confirmed) 3. XLK Technology (YTD #1; correction hurt but recovery candidate) | **AVOID: XLE (oil falling on deal), XLC (GOOGL issues), XLRE (rate-sensitive)**
